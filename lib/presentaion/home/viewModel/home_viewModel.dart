...
class HomeViewModel {
  ...
  Future<DailyCategoryResponseDTO?> fetchDailyCategoryStats(
    String statDate,
  ) async {
    final token = await TokenStorage.getToken();
    //TODO: - 여기 변경
  ...
  Future<DailyCategoryResponseDTO?> fetchWeeklyCategoryStats(
    int year,
    int weekNum,
  ) async {
    final token = await TokenStorage.getToken();
  ...
  Future<DailyCategoryResponseDTO?> fetchMonthlyCategoryStats(
    int year,
    int month,
  ) async {
    final token = await TokenStorage.getToken();
